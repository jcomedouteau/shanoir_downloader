...
def anonymize_fields(anonymization_fields, dicom_files, dicom_output_path, sequence_id, patient_id, shanoir_name):
	for dicom_file in dicom_files:
		...
		if (ds[int('0x' + '0010', base=16),int('0x' + '1000', base=16)]):
			ds[int('0x' + '0010', base=16),int('0x' + '1000', base=16)].value = sequence_id
		else:
			ds[int('0x' + '0010', base=16),int('0x' + '1000', base=16)] = new
...
def create_arg_parser():
	...
	parser.add_argument('-ue', '--unrecofileverable_errors', default=['status_code_404', 'anonymization_error', 'zip_compression_error', 'encryption_error'], nargs='*', help='The errors which should not trigger a new download.')
